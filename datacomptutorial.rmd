...
Schedule for Data Science Day on __Thursday, November 13__ at Room 407 in The DeNaples Center. 
...
- 12:00-1:00 __Lunch and keynote speaker__ Stephen Sorokanich: Quantum Fellow at Air Force Research Laboratory.
...
If you have registered, you will receive a parking pass via email a few days before the event.  You'll be parking in the __Ridge Row__ parking lot.  A map of the campus be downloaded below.  Not that Ridge Row is the C parking lot (near the bottom right of the map), and DeNaples Hall, where the event is held, is labeled 38 and located near the map center. The event will be held in the Ballroom, Room 407 D, which can be accessed through the main set of stairs or the elevator located next to the stairs.


[Campus parking map](https://www.scranton.edu/about/university-police/parking/campus-parking-map1.pdf)

If you have registered but have not received a parking pass by Monday Nov. 3, please email joseph.klobusicky \<at\> scranton \<dot\> edu.
