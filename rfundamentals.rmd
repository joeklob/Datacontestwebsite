...
This page gives a lightning quick overview of how R works.  Of course we can't cover everything that R does here, but the material in this page and the [sample dataset page](https://scrantondatacontest.netlify.app/rfundamentals) will be sufficient to answer all of the questions in the data science competition.
